import { retry, timeSpan, type TimeEndFunction } from '../../lib/main.js'
...
export class DummyRunner {
  ...
  constructor(test: Test<any>, emitter: Emitter) {
    this.#test = test
...
export class TestRunner {
   ...
   */
  #setupRunner: Runner<TestHooksData[0], TestHooksData[1]>

  /**
   * Reference to the cleanup runner
   */
  #teardownRunner: Runner<TestHooksData[0], TestHooksData[1]>
   ...
   */
  #callbacks: {
    executing: ((test: Test<any>) => void)[]
    executed: ((test: Test<any>, hasError: boolean, errors: TestEndNode['errors']) => void)[]
  }
