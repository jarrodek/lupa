...
export class Refiner {
   ...
   */
  #isTestTitleAllowed(test: Test<any>): boolean {
    /**
   ...
   */
  #allowedByNegatedTags(test: Test<any>): boolean {
   ...
   */
  #allowedByTags(test: Test<any>): boolean {
   ...
   * for the test tags
   */
  #areTestTagsAllowed(test: Test<any>): boolean {
   ...
   */
  #isAllowedByPinnedTest(test: Test<any>): boolean {
    /**
